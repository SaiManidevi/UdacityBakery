...
public class BakeryConstants {
    ...
    public static final String STATE_STEP_DESC = "stepDescription";
    public static final String STATE_STEP_URL = "stepVideoUrl";
    public static final String STATE_PLAYBACK_POSITION = "playback_position";
}
